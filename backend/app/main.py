...
from app.routers import auth, closet, email_ingest, marketplace, notifications, outfit, social, shop, style, trips
...
app.include_router(style.router, prefix=settings.API_V1_PREFIX)
